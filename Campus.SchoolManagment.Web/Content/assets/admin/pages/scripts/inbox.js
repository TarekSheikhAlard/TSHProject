var Inbox = function () {
    ...
    var initWysihtml5 = function () {
        $('.inbox-wysihtml5').wysihtml5({
            "stylesheets": ["~/Content/theme/assets/global/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
        });
    }
    ...
    var initFileupload = function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: '~/Content/theme/assets/global/plugins/jquery-file-upload/server/php/',
            autoUpload: true
        });
